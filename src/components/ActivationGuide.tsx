...
export function ActivationGuide() {
  ...
  const trackStep = (stepId: string, path: string) => { void trackRuntimeEvent({ workspaceId, ...productEvent(productEventNames.activationAction, { stepId, path, percent: activation.percent }) }); };

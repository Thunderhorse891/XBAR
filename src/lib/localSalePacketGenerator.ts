...
/*
 * A seller contact row, its value in a cell the packet's verifier finds by name
 * and compares with the sealed record. The contact block is where a buyer

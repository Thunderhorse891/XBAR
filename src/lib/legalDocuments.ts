...
export const legalDocuments: LegalDocument[] = [
  {
    ...
    purpose:
      'Customer-facing agreement for account access, subscriptions, data ownership, disclaimers, and liability limits.',
    ...
    sections: [
      {
        title: 'Acceptance',
        body: [
          'These Terms govern access to and use of the XBAR LLC platform, applications, document tools, buyer packet workflows, and related services.',
          'By creating an account, accessing a workspace, starting a subscription, or using the service, the user agrees to these Terms.',
        ],
      },
      {
        title: 'Service description',
        body: [
          'XBAR LLC provides ranch and horse operation software for horse records, proof control, title and transfer posture, care status, buyer movement, operating ledger workflows, document intake, and buyer packet preparation.',
      ...
      },
      {
        ...
        body: [
          'Paid plans are subscription services. Unless otherwise stated at checkout, subscriptions renew automatically until canceled.',
          'The user authorizes recurring charges for the selected plan and approved add-ons, seats, storage, or usage-based charges. Stripe or another payment processor may handle payment processing.',
        ],
      },
      {
        title: 'Customer data',
        body: [
          'The customer retains ownership of ranch, horse, document, buyer, ownership, medical, expense, and operational data entered into the service.',
          'XBAR LLC may host, process, transmit, display, secure, back up, and use that data as needed to provide and improve the service.',
        ],
      },
      {
        title: 'No professional advice',
        body: [
          'XBAR does not provide legal, veterinary, medical, tax, accounting, insurance, registry, appraisal, brokerage, or financial advice.',
          'Generated forms, templates, alerts, readiness scores, proof summaries, and buyer packet workflows are operational aids only. Users should consult qualified professionals before relying on them.',
        ],
      },
      {
        title: 'Buyer packets',
        body: [
          'Buyer-facing profiles, sale packets, shared links, public packets, and generated documents contain information supplied, selected, approved, or released by the user.',
          'XBAR LLC does not independently verify horse identity, registration status, title, ownership, lien status, medical condition, sale terms, or health records. Buyers and sellers must independently verify all information.',
        ],
      },
      {
  ...
  },
  {
    ...
    purpose:
      'Privacy notice covering account data, ranch records, documents, buyer links, payments, storage, retention, and third-party processors.',
    lastUpdated: legalLastUpdated,
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'XBAR uses information to provide the service, authenticate users, sync workspaces, generate documents, organize proof records, create buyer packets, process subscriptions, provide support, improve reliability, maintain security, and comply with legal obligations.',
      ...
      },
      {
        ...
        body: [
          'XBAR may use service providers for hosting, authentication, database storage, object storage, payments, email, analytics, error monitoring, weather data, and document processing.',
        ],
      },
      {
        title: 'Retention and deletion',
        body: [
          'Customer data is generally retained while the account or workspace is active and as needed for backups, legal obligations, security, billing, and dispute resolution. Customers should export critical records before deleting data or canceling service.',
        ],
      },
      {
        title: 'Security',
  ...
  },
  {
    ...
    purpose:
      'Commercial charging language for paid plans, recurring billing, cancellations, refunds, plan changes, taxes, and payment processors.',
    lastUpdated: legalLastUpdated,
  ...
  },
  {
    ...
    purpose:
      'Specific disclaimer for horse records, buyer packets, Coggins, veterinary data, title transfer, ownership claims, and generated documents.',
    lastUpdated: legalLastUpdated,
    ...
    sections: [
      ...
      {
        title: 'No veterinary or transfer advice',
        body: [
          'XBAR care status and transfer workflows are operational tracking tools only. XBAR does not determine veterinary treatment, legal ownership, lien priority, registry eligibility, escrow status, or transfer validity.',
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: 'No license without permission',
        body: [
      ...
      {
        title: 'Buyer packet attribution',
        body: [
    ...
    sections: [
      {
        ...
        body: [
          'Users may not knowingly upload, create, approve, or share false, altered, misleading, unauthorized, or incomplete records intended to mislead buyers, owners, registries, veterinarians, insurers, lenders, courts, tax authorities, or other third parties.',
        ],
      },
      {
      ...
      {
        title: 'Shared links and public content',
        body: [
...
export const legalDocumentById: Record<LegalDocumentId, LegalDocument> = legalDocuments.reduce(
  (accumulator, legalDoc) => {

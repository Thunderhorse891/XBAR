...
export const documentTemplateLibrary: DocumentTemplate[] = [
  ...
  { id: 'coggins-health-certificate', tier: 'Basic', label: 'Coggins & Health Certificate Form', purpose: 'Pre-filled horse and owner fields for annual testing and travel health documents.', minimumPlan: 'Starter' },

  ...
  return (
    <>
      ...
      {activeStage === 'Processing' ? (
        <Panel
          title="Stage 2 · Document Intelligence"
          description="Document intelligence runs locally; fields below were extracted automatically."
          className="cursor-context-menu"
        ...
        >
          {queuedDocuments.length || processingBatches.length ? (
            ...
            <EmptyState
              ...
              description="Document intelligence is idle. Upload documents in stage 1 to feed the queue."
              action={

      ...
      <div className="surface-hero surface-hero--dark">
        <div className="surface-hero__top">
          ...
          <div className="surface-hero__stats">
            ...
            <div className="surface-hero__stat"><span>Blockers</span><strong style={{ color: localSalePacket?.blockers.length ? 'var(--rose)' : 'var(--emerald)' }}>{localSalePacket?.blockers.length ?? 0}</strong></div>
            <div className="surface-hero__stat"><span>Included proof</span><strong>{selectedDocumentIds.length}</strong></div>
            <div className="surface-hero__stat"><span>Status</span><strong>{localSalePacket?.releaseStatus ?? 'Not ready'}</strong></div>
          </div>
        </div>
      </div>

...
type NavItem = {
  ...
  section: 'Command' | 'Operations' | 'Control';
...
const routeHelp: Record<string, HelpSection[]> = {
  'Command Center': [
    ...
    { label: 'Local workspace', text: 'This workspace is private to this browser until cloud sync is connected. Export backups before changing devices.' },
  ],
  'Command Files': [

...
export default function Terms() {
  ...
  return (
    <main style={{ maxWidth: '860px', margin: '0 auto', padding: 'clamp(32px,6vw,80px) clamp(16px,4vw,40px)', color: '#e8f2ff', fontFamily: 'inherit' }}>
      ...
      <h1 style={{ fontSize: 'clamp(1.6rem,3vw,2.4rem)', fontWeight: 800, letterSpacing: '-0.04em', marginBottom: '8px' }}>{terms.title}</h1>
      <p style={{ color: 'rgba(140,175,210,0.72)', marginBottom: '18px', fontSize: '13px' }}>Last updated: {terms.lastUpdated}</p>
      <p style={{ border: '1px solid rgba(77,148,255,0.28)', background: 'rgba(8,19,34,0.88)', borderRadius: '14px', padding: '14px', color: 'rgba(200,223,240,0.82)', lineHeight: 1.7, fontSize: '14px', marginBottom: '34px' }}>{terms.notice}</p>

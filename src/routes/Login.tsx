...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#edf0f4] px-5 py-8">
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-[1180px] gap-6 lg:grid-cols-[0.95fr,1.05fr]">
        <section className="flex flex-col justify-between rounded-2xl border border-[#11161c] bg-[#090b0d] p-8 text-white shadow-sm">
          <div>
            <div className="flex items-center gap-3">
              <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-white/8 bg-white/[0.03] p-1.5">
              ...
              <div>
                ...
                <div className="text-[10px] font-semibold uppercase tracking-[0.28em] text-white/42">Horse Ledger</div>
              </div>
            </div>

            <div className="mt-10">
              <div className="text-[10px] font-semibold uppercase tracking-[0.28em] text-white/40">Secure access</div>
              <h1 className="mt-3 text-[clamp(2.3rem,4vw,4rem)] font-bold tracking-[-0.07em] text-white">Sign in</h1>
              <p className="mt-4 max-w-[28rem] text-sm leading-7 text-white/66">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-xl border border-white/8 bg-white/[0.03] px-4 py-3">
              <div className="text-[10px] font-semibold uppercase tracking-[0.24em] text-white/38">Auth</div>
              <div className="mt-2 text-sm font-semibold text-white">{isSupabaseConfigured() ? 'Supabase live' : 'Local mode'}</div>
            </div>
            <div className="rounded-xl border border-white/8 bg-white/[0.03] px-4 py-3">
              <div className="text-[10px] font-semibold uppercase tracking-[0.24em] text-white/38">Access</div>
              <div className="mt-2 text-sm font-semibold text-white">Role-aware</div>
            </div>
            <div className="rounded-xl border border-white/8 bg-white/[0.03] px-4 py-3">
              <div className="text-[10px] font-semibold uppercase tracking-[0.24em] text-white/38">Sync</div>
        ...
        <section className="flex items-center">
          <div className="w-full rounded-2xl border border-[#dce4ec] bg-white p-8 shadow-sm">
            <div className="flex items-center justify-between gap-3">
              <div>
                <div className="text-[10px] font-semibold uppercase tracking-[0.28em] text-[#667085]">Workspace login</div>
                <h2 className="mt-2 text-[1.7rem] font-bold tracking-[-0.05em] text-[#202225]">Enter XBAR</h2>
              </div>
            ...
            {isSupabaseConfigured() ? (
              <>
                ...
                <div className="mt-6 rounded-xl border border-[#e2e7ed] bg-[#f8fafc] px-4 py-4 text-sm leading-6 text-[#52616d]">
                  Use your email to receive a secure sign-in link, or continue with Facebook if your workspace enables that connector.
                </div>
              </>
            ) : (
              <div className="mt-8 rounded-xl border border-[#e2e7ed] bg-[#f8fafc] px-4 py-4 text-sm leading-7 text-[#52616d]">

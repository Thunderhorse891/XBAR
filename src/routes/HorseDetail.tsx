...
export default function HorseDetail() {
  ...
  return (
    <>
      ...
      {/* Horse Identity Hero */}
      <section className="horse-detail-hero">
        {/* Subtle grid pattern */}
        ...
        <div className="relative z-10 flex flex-col gap-5 p-6 xl:flex-row xl:items-end xl:justify-between xl:gap-8">
          <div className="min-w-0 flex-1">
            <div className="mb-3 flex items-center gap-3">
              <span className="text-[10px] font-bold uppercase tracking-[0.26em] text-[var(--muted)]">{horse.ownerEntity}</span>
              {hasRestrictedActions ? (
                <span
                  className="inline-flex h-7 w-7 items-center justify-center rounded border border-[var(--border)] bg-[var(--surface-raised)] text-[var(--muted)] transition-all duration-150 ease-[ease]"
            ...
            <h1 className="text-[clamp(2.2rem,5vw,3.8rem)] font-extrabold leading-[0.92] tracking-[-0.07em] text-[var(--text)]">
              {horse.name}
            </h1>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <div className="flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--surface)] px-3 py-2 shadow-sm">
                <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--muted)]">Packet</span>
                <span className={classNames(
                  'text-[13px] font-bold tabular-nums',
                  packet.score >= 75 ? 'text-[var(--emerald)]' : packet.score >= 50 ? 'text-[var(--amber)]' : 'text-[var(--rose)]',
                )}>{packet.score}%</span>
              </div>
              <div className="flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--surface)] px-3 py-2 shadow-sm">
                <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--muted)]">Docs</span>
                <span className="text-[13px] font-bold tabular-nums text-[var(--text)]">{documents.length}</span>
              </div>
              <div className="flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--surface)] px-3 py-2 shadow-sm">
                <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--muted)]">Status</span>
                <span className={classNames(
              ...
              {ownershipRecord ? (
                <div className="flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--surface)] px-3 py-2 shadow-sm">
                  <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--muted)]">Ownership</span>
                  <span className={classNames(
                    'text-[13px] font-bold',
                    ownershipRecord.transferStatus === 'Clear' ? 'text-[var(--emerald)]' : 'text-[var(--rose)]',
          ...
          <div className="flex shrink-0 flex-wrap gap-2 xl:flex-col">
            {saved ? (
              <a
                className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-[rgba(37,99,235,0.4)] bg-[var(--blue)] px-5 text-sm font-semibold text-white shadow-sm transition-all duration-150 ease-[ease] hover:bg-[var(--blue-dark)]"
                href={publicShareUrl}
                target="_blank"
                rel="noreferrer"
              ...
              <button
                className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-[rgba(37,99,235,0.35)] bg-[var(--blue)] px-5 text-sm font-semibold text-white shadow-sm transition-all duration-150 ease-[ease] hover:bg-[var(--blue-dark)] disabled:cursor-not-allowed disabled:opacity-40"
                type="button"
        ...
        <div className="relative flex h-full flex-col overflow-hidden rounded-[10px] border border-[var(--border)] bg-[var(--surface)] p-5 shadow-sm">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface-strong)] px-4 py-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                className="inline-flex h-10 items-center justify-center rounded-md bg-[var(--blue)] px-4 text-sm font-semibold text-white shadow-sm transition-all duration-150 ease-[ease] hover:bg-[var(--blue-dark)] disabled:cursor-not-allowed disabled:opacity-50"
                type="button"
